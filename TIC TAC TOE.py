...
def btnClick(buttons):
    ...
    if buttons["text"] ==" " and bclick:
        ...
        tkinter.messagebox.showinfo("TicTacToe","Buttons already clicked")
...
def checkforwin():
    if (button1['text'] == "X" and button2['text'] == "X" and button3['text'] == "X" or
        ...
        button3['text'] == "X" and button5['text'] == "X" and button8['text'] == "X" ):
        disableButton()
        ...
        tkinter.messagebox.showinfo("Tic Tac Toe","It is a Tie")
          ...
          button3['text'] == "O" and button5['text'] == "O" and button8['text'] == "O" ):
        disableButton()
